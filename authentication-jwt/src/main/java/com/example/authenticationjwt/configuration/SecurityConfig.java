...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINT = {"/users/v1/create-user", "/v1/authenticate/login", "/v1/authenticate/introspect"};
//    private final String[] ADMIN_ENDPOINT = {"/users/v1/users"};
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.oauth2ResourceServer(oauth2 -> oauth2
                ...
                .authenticationEntryPoint(new JwtAuthenticationEntryPointConfiguration())
        );
    ...
    JwtDecoder jwtDecoder() {
        SecretKeySpec secretKeySpec = new SecretKeySpec(signerKey.getBytes(), "SHA512");
